 ...
 */
export declare const DEFAULT_CONFIG: Required<Pick<ValidatorConfig, 'sensitivity' | 'action' | 'enabled' | 'logLevel' | 'includeFindings'>>;
/**
 * Merge user config with defaults
 */
export declare function mergeConfig<T extends ValidatorConfig>(userConfig?: T): T & Required<Pick<ValidatorConfig, 'sensitivity' | 'action' | 'enabled' | 'logLevel' | 'includeFindings'>>;
/**
 * Get risk threshold based on sensitivity level
 */
export declare function getRiskThreshold(sensitivity: SensitivityLevel): number;
//# sourceMappingURL=ValidatorConfig.d.ts.map