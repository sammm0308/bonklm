...
export const connectorTestCommand = new Command('test')
    ...
    throw new WizardError('NOT_IMPLEMENTED', `Connector test command is not yet implemented for: ${id}`, 'See EPIC-5 for implementation details', undefined, 2 // Partial - CLI is functional, test is not
    );
});
