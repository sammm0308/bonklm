 ...
 * @internal
 */
export declare const DEFAULT_MAX_ARGUMENT_SIZE: number;
/**
 * Default validation timeout (5 seconds).
 *
 * @internal
 */
export declare const DEFAULT_VALIDATION_TIMEOUT = 5000;
/**
 ...
 */
export declare const VALID_TOOL_NAME_PATTERN: RegExp;
/**
