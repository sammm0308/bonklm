...
const CSS_HIDDEN_PATTERNS: WebPatternDef[] = [
  {
...
const META_TAG_PATTERNS: WebPatternDef[] = [
  {
...
const DATA_ATTRIBUTE_PATTERNS: WebPatternDef[] = [
  {
...
const MARKDOWN_INJECTION_PATTERNS: WebPatternDef[] = [
  {
...
const ALL_WEB_PATTERNS: WebPatternDef[] = [
  ...CSS_HIDDEN_PATTERNS,
  ...META_TAG_PATTERNS,
 ...
 */
export function analyzeWebContent(content: string): WebContentFinding[] {
  const findings: WebContentFinding[] = [];
...
const urlReputation: Map<string, UrlReputationEntry> = new Map();

/**
 * Record a URL finding for reputation tracking.
 * Returns the updated entry.
 */
export function recordUrlFinding(
  url: string,
  findingCount: number,
  severity: Severity,
): UrlReputationEntry {
  ...
  if (urlReputation.size >= MAX_TRACKED_URLS) {
    ...
    if (oldestKey) urlReputation.delete(oldestKey);
  }

  const entry: UrlReputationEntry = {
    url,
 ...
 */
export function getUrlReputation(url: string): UrlReputationEntry | null {
 ...
 */
export function getTrackedUrls(): UrlReputationEntry[] {
 ...
 */
export function clearUrlReputation(): void {
  urlReputation.clear();
}
 ...
 * - else → INFO
 */
export function computeEffectiveSeverity(findings: WebContentFinding[]): Severity {
