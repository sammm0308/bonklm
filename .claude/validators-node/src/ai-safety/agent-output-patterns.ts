...
const FAKE_TOOL_CALL_PATTERNS: AgentPatternDef[] = [
  {
...
const PRIVILEGE_ESCALATION_PATTERNS: AgentPatternDef[] = [
  {
...
const SELF_REFERENTIAL_PATTERNS: AgentPatternDef[] = [
  {
...
const ALL_AGENT_PATTERNS: AgentPatternDef[] = [
 ...
 */
export function analyzeAgentOutput(content: string): AgentOutputFinding[] {
  const findings: AgentOutputFinding[] = [];
