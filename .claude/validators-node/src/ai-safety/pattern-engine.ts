...
// =============================================================================
// TPI-12: SYNONYM SUBSTITUTION PATTERNS
// =============================================================================

/**
 * Synonym expansion patterns for critical injection categories.
 * These are ADDITIVE — original patterns remain unchanged (AC2).
 * SYSTEM_OVERRIDE/CONSTRAINT_REMOVAL synonyms retain original severity (P1-2, AC3).
 */
