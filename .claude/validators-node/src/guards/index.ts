...
export {
  ...
  isProtectedFile,
  isAllowedPattern,
  main as envProtectionMain,
} from './env-protection.js';
...
export {
  ...
  checkBashCommand,
  checkFilePath,
  main as outsideRepoMain,
} from './outside-repo.js';
