 ...
 */
export function preprocessPath(input) {
    if (!input) {
        return '';
    }
    let result = input;
 ...
 */
export function sanitizePath(absolutePath, projectDir = getProjectDir()) {
    if (!absolutePath) {
        return '';
    }
 ...
 */
export function sanitizeErrorMessage(message, projectDir = getProjectDir()) {
    if (!message) {
        return '';
    }
