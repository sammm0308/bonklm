 ...
 */
export function sendAlertSync(payload) {
    // Check if should alert based on severity
    if (!shouldAlert(payload.severity)) {
        return;
    }
 ...
 */
export function alertCritical(validator, eventType, message, details) {
    sendAlertSync({
        severity: 'CRITICAL',
 ...
 */
export function alertBlocked(validator, eventType, message, details) {
    sendAlertSync({
        severity: 'BLOCKED',
        event_type: eventType,
        validator,
 ...
 */
export function alertWarning(validator, eventType, message, details) {
    sendAlertSync({
        severity: 'WARNING',
        event_type: eventType,
        validator,
