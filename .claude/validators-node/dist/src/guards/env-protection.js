 ...
 */
export function isAllowedPattern(filename) {
 ...
 */
function checkCloudConfigPath(filePath) {
 ...
 */
function isHiddenSensitiveFile(filename) {
 ...
 */
export function validateEnvProtection(filePath) {
    if (!filePath) {
    ...
    if (overrideResult.valid) {
        ...
        printOverrideConsumed(`Protected file modification: ${reason}`, 'BMAD_ALLOW_SENSITIVE_FILES');
        return EXIT_CODES.ALLOW;
    }
    // Block the operation
...
//# sourceMappingURL=env-protection.js.map