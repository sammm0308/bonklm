 ...
 */
export function validateProductionGuard(content, filePath) {
    if (!content) {
    ...
    if (overrideResult.valid) {
        ...
        printOverrideConsumed(`Production targeting detected: ${indicators.length} indicator(s) found`, 'BMAD_ALLOW_PRODUCTION');
        return EXIT_CODES.ALLOW;
    }
    // Block the operation
